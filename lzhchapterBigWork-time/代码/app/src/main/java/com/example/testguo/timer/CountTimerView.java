...
public class CountTimerView extends LinearLayout {
    ...
    public CountTimerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onFinishInflate(){
        ...
        btnPause.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                etSecond.setCursorVisible(true);
        ...
        btnResume.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imm.hideSoftInputFromWindow(etHour.getWindowToken(),0);
